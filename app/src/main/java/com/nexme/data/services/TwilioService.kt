...
interface TwilioService {
    ...
    fun checkPhoneVerify(@Query("api_key") apiKey: String, @Query("via") via: String, @Query("country_code") countryCode: String, @Query("phone_number") phoneNumber: String, @Query("verification_code") verificationCode: String ): Observable<PhoneResponseEntity>
}